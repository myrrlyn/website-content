...
#set text(
  font: ("Roboto Slab", "Roboto", "Iosevka Etoile"),
  lang: "en",
  region: "US",
  hyphenate: true,
  kerning: true,
...
- drivetrain and control system component selection and assembly
- freestanding control software design and implementation
- device driver implementation for:
  - GPS receiver and magnetometer (orientation)
...
I am a PADI rescue diver, former lifeguard instructor, and current
#link("https://www.ecsinstitute.org/about-ecsi/about", [ECSI]) wilderness first
aid and CPR instructor. I believe strongly in the importance of imposing safety
onto a hazardous environment, and bring this focus to all aspects of my work.
